...
var UploadController = /** @class */ (function () {
    ...
    UploadController.prototype.uploadImage = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, base64Str, folder, uploadResponse, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = req.body, base64Str = _a.base64Str, folder = _a.folder;
                        return [4 /*yield*/, cloudinary_1.cloudinary.uploader.upload(base64Str, {
                                folder: folder,
                            })];
                    case 1:
